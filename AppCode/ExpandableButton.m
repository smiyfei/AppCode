...
@interface DDExpandableButtonCustomUILabel : UILabel <ExpandableButtonViewSource>
...
@interface DDExpandableButtonCustomUIImageView : UIImageView <ExpandableButtonViewSource>
...
- (void)setButtons:(NSArray *)buttons
{
	...
	{
		EXView *v = [self getViewFrom:button];
		[self addSubview:v];
		[_labels addObject:v];
	}
...
- (CGRect)shrunkFrameRect
{
	...
	{
		EXView *currentLabel = [labels objectAtIndex:selectedItem];
...
- (CGRect)expandedFrameRect
{
	...
	{
		EXView *lastLabel = [labels lastObject];
