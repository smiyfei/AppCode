...
#define EXView UIView <ExpandableButtonViewSource>

@protocol ExpandableButtonViewSource;

@interface ExpandableButton : UIControl
{
	BOOL		expanded;
	BOOL		useAnimation;
	BOOL		toggleMode;
...
@protocol ExpandableButtonViewSource <NSObject>
